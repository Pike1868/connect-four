...
startBtn.addEventListener("click", function () {
  ...
  if (player1Name === "" || player2Name === "") {
    alert("Please enter a name and choose a color for each player");
    return;
  }
  let player1 = new Player(player1Name, player1Color);
  let player2 = new Player(player2Name, player2Color);
